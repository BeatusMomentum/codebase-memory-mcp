...
|---|:---:|---|---|
| arkts | 15 | **first-party derivative**: forked from tree-sitter/tree-sitter-typescript @ `75b3874edb2d` (v0.23.2; javascript base @ `3a837b6f3658` v0.23.1); grammar source in `tools/tree-sitter-arkts/` | MIT, (c) 2017 Max Brunsfeld (verbatim) + (c) 2026 DeusData additions — see summary note |
